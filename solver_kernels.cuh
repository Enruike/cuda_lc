...
__global__ void relax_bulk(const double* d_Qin, double* d_Qout, unsigned char* d_bulktype, signed int* d_neighbor, unsigned int* d_Qtensor_index, unsigned char* d_Qtensor_signal, double U,
...
__global__ void relax_surf(const double* d_Qin, double* d_Qout, signed int* d_neighbor, unsigned int* d_Nvector_index, unsigned char* d_Nvector_signal, double* d_Qo,
